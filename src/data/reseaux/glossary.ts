...
export const GLOSSAIRE: TermeGlossaire[] = [
  ...
  { terme: 'Codage de ligne', def: 'Façon de représenter les bits 0 et 1 par des niveaux ou transitions de tension sur le support (NRZ, Manchester…). L’enjeu central est de garantir assez de transitions pour que le récepteur récupère l’horloge — ce que Manchester assure et que NRZ ne fait pas sur les longues suites.', voir: '/reseaux/partie-ii/codage-ligne', alias: ['NRZ', 'Manchester', 'codage'] },
  ...
  { terme: 'HTTP', def: 'HyperText Transfer Protocol : protocole requête/réponse du web, fondé sur des méthodes (GET, POST…) et des codes de statut, transporté sur TCP (HTTP/1.1, HTTP/2) ou, depuis HTTP/3, sur QUIC au-dessus d’UDP.', voir: '/reseaux/partie-vi/http-web', alias: ['web', 'requête', 'réponse', 'méthode', 'code de statut'] },
