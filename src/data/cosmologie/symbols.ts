...
export const SYMBOLES: Symbole[] = [
  ...
  { katex: '\\rho', nom: 'Densité de masse-énergie', desc: 'Densité de masse-énergie d’une composante (matière, rayonnement, Λ). Source du champ gravitationnel cosmique.', unite: 'kg·m⁻³', voir: '/cosmologie/partie-ii/contenu-univers' },
  { katex: '\\rho_c', nom: 'Densité critique', desc: 'Densité qui rend l’univers spatialement plat : ρc = 3H²/(8πG).', unite: 'kg·m⁻³', valeur: '≈ 8,6×10⁻²⁷ kg/m³ (≈ 5 protons/m³, pour H₀ ≈ 67,7)', voir: '/cosmologie/partie-ii/parametres-densite' },
