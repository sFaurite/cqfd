...
export const GLOSSAIRE: TermeGlossaire[] = [
  ...
  { terme: 'Énergie de liaison', def: 'Énergie qu’il faut fournir pour séparer les constituants d’un système lié (noyau, atome, molécule). Compte négativement dans la masse totale. Le proton est l’exception inverse : l’énergie de confinement y ajoute l’essentiel de la masse (voir « Masse = énergie confinée »).', voir: '/physique/partie-ii/masse-energie-confinee' },
  ...
  { terme: 'Effet photoélectrique', def: 'Émission d’électrons par un métal éclairé. Son seuil en fréquence a conduit Einstein à postuler que la lumière échange l’énergie par quanta E = hν (1905), hypothèse confirmée ensuite (effet Compton, optique quantique).', voir: '/physique/partie-iii/echec-classique' },
  ...
  { terme: 'Hadron', def: 'Particule composite faite de quarks liés par la force forte : baryons (3 quarks, ex. proton) et mésons (quark + antiquark, ex. pion) ; des états exotiques (tétraquarks, pentaquarks) ont aussi été observés depuis 2015.', voir: '/physique/partie-v/interaction-forte' },
