...
export const SYMBOLES: Symbole[] = [
  ...
  { katex: 'e', nom: 'Nombre d’Euler (base)', desc: 'e = Σ 1/n!. Irrationnel, et même transcendant.', valeur: '≈ 2,718281828', voir: '/maths/partie-v/series' },
  ...
  { katex: '\\zeta(s)', nom: 'Fonction zêta', desc: 'ζ(s) = Σ 1/nˢ (pour s > 1), prolongée analytiquement à ℂ∖{1} (pôle en 1). L’hypothèse de Riemann porte sur les zéros de ce prolongement.', voir: '/maths/partie-vi/grandes-conjectures' },
];
