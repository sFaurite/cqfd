...
export const GLOSSAIRE: TermeGlossaire[] = [
  ...
  { terme: 'Théorèmes d’incomplétude (Gödel)', def: 'Résultats (1931) : tout système d’axiomes cohérent et assez riche pour l’arithmétique contient des énoncés vrais qu’il ne peut démontrer, et ne peut prouver sa propre cohérence.', voir: '/maths/partie-i/methode-axiomatique' },
  ...
  { terme: 'Nombre réel (ℝ)', def: 'Défini comme une coupure de Dedekind de ℚ. Comble les trous de ℚ (ex. √2) ; ℝ est complet (toute partie majorée a une borne supérieure).', voir: '/maths/partie-ii/reels-dedekind' },
];
