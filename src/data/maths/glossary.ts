...
export const GLOSSAIRE: TermeGlossaire[] = [
  ...
  { terme: 'Cohérence (consistance)', def: 'Propriété d’un système d’axiomes qui ne permet pas de démontrer une contradiction. Par les théorèmes de Gödel, un système assez riche ne peut prouver sa propre cohérence.', voir: '/maths/partie-vi/godel' },
  ...
  { terme: 'Produit cartésien (A × B)', def: 'Ensemble de tous les couples (a, b) avec a ∈ A et b ∈ B. Construit par séparation dans un ensemble de parties.', voir: '/maths/partie-i/relations-fonctions' },
  ...
  { terme: 'Nombre premier', def: 'Entier > 1 dont les seuls diviseurs sont 1 et lui-même ; caractérisé par le lemme d’Euclide (p | ab ⇒ p | a ou p | b). Il en existe une infinité (Euclide).', voir: '/maths/partie-iv/arithmetique' },
  ...
  { terme: 'Conjecture', def: 'Énoncé cru vrai mais non démontré (Riemann, Goldbach, P vs NP…). Statut distinct d’« indécidable » : une conjecture peut tomber demain.', voir: '/maths/partie-vi/grandes-conjectures' },
