...
export const GLOSSAIRE: TermeGlossaire[] = [
  ...
  { terme: 'Approximation universelle', def: 'Théorème : un réseau à une couche cachée assez large peut approcher n’importe quelle fonction continue. <em>Existence</em> d’un réseau — pas garantie qu’on l’apprenne.', voir: '/ia/partie-iii/approximation-universelle', alias: ['théorème d’approximation universelle'] },
